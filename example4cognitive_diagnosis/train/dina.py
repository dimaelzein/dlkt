...
from config.dina_config import dina_config

from lib.util.parse import str2bool
from lib.util.set_up import set_seed
from lib.dataset.CDDataset import CDDataset
from lib.model.DINA import DINA
...
if __name__ == "__main__":
    ...
    global_params, global_objects = dina_config(params)
    ...
    model = DINA(global_params, global_objects).to(global_params["device"])
