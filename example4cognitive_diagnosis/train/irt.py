...
from config.irt_config import irt_config

from lib.util.parse import str2bool
from lib.util.set_up import set_seed
from lib.dataset.CDDataset import CDDataset
from lib.model.IRT import IRT
...
if __name__ == "__main__":
    ...
    global_params, global_objects = irt_config(params)
    ...
    model = IRT(global_params, global_objects).to(global_params["device"])
