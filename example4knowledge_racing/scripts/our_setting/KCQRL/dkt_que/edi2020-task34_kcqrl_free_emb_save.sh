...

{
  ...
  do
    ...
    python /ghome/xiongzj/code/dlkt-release/example/train/dkt_que.py \
      ...
      --num_question 948 --que_emb_file_name "qid2content_sol_avg_emb.json" --frozen_que_emb False \
...
} >> /ghome/xiongzj/code/dlkt-release/example/result_cluster/our_setting_dkt_que_kcqrl_free_emb_edi2020-task34_save.txt