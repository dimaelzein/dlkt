...
if __name__ == "__main__":
    ...
    parser.add_argument("--file_path", type=str,
                        default=r"/Users/dream/myProjects/dlkt-release/example4knowledge_racing/result_cluster/our_setting_dkvmn_que_kcqrl_CL-no-cluster_only-original-KC_free_emb_xes3g5m_save.txt")
