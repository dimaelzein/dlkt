...

{
  ...
  do
    ...
    python /ghome/xiongzj/code/dlkt-release/example/train/dkvmn_que.py \
      ...
      --dim_key 128 --dim_value 32 --dropout 0.1 \
      --save_model True --debug_mode False --use_cpu False --seed 0 --trace_epoch True
  done
} >> /ghome/xiongzj/code/dlkt-release/example/result_cluster/our_setting_dkvmn_que_kcqrl_CL-no-cluster_only-original-KC_free_emb_edi2020-task34_save.txt