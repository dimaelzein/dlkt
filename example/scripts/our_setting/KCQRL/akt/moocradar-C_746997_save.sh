...

{
  ...
  do
    echo -e "fold: ${fold}"
    python /ghome/xiongzj/code/dlkt-release/example/train/akt.py \
...
} >> /ghome/xiongzj/code/dlkt-release/example/result_cluster/our_setting_akt_moocradar-C_746997_save.txt